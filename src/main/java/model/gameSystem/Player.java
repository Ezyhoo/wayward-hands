...
public class Player {
	...
	public boolean raise(int highestBet, int raiseValue) {
	...
	public void takeAction(String action, int highestBet, int num){
		if(action.equals("raise")){
			raise(highestBet, num);
		}
