...
public class Menu {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			case 1:
				...
				break;
			case 2:
				System.out.println("Create user not completed");
				/**
				User user = new User(1);
				user.setGamePlayed(10);
				System.out.println(user);
				FileIO fileIO = new FileIO();
				String path = "user1.dat";
				fileIO.writeObjectToFile(user, path);
				
				User loadUser;
				loadUser = fileIO.readObjectFromFile(path);
				System.out.println(loadUser);
				**/
				break;
			case 3:
				System.out.println("Load user not completed");
				break;
			case 4:
				changeSetting(scanner);
				break;
			case 5:
				System.out.println("Show statistics not completed");
				break;
			case 6:
				Help.viewRule();
				break;
	...
	public static void printMenu() {
		...
		System.out.println("2. Create User (Incompleted)");
		System.out.println("3. Load User (Incompleted)");
		System.out.println("4. Change Setting");
		System.out.println("5. Show statistics (Incompleted)");
		System.out.println("6. View Rule");
